...
![local-balance](./images/local-balancing.png)
...
Для обеспечения резервирования используется схема N*2. Прична использования - снижение времени простоя [1] и обеспечении работоспособности при пиковых нагрузках не сервис.
...
| Итоговое количество серверов с учётом резервирования N * 2             |        18 |
