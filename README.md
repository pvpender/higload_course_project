...
|                     |  Запись  |   -   |             -              |    -    |                                                    Относительно мало записей |
| Artist              |  Чтение  | 19423 |             1              |  19423  |              Поиск, кроме того всегда нужен при получении информации о треке |
|                     |  Запись  |   -   |             -              |    -    |                                                                              |
| TrackArtist         |  Чтение  | 19423 |             1              |  19423  |              Поиск, кроме того всегда нужен при получении информации о треке |
|                     |  Запись  |   -   |             -              |    -    |                                                                              |
